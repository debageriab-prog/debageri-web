...
const COLOR_PATTERN = /^(#[0-9a-f]{3,8}|rgb\(\s*\d{1,3}\s*,\s*\d{1,3}\s*,\s*\d{1,3}\s*\)|[a-z]{3,20})$/i;

export function sanitizeJobDescription(value: string): string {
  return sanitizeHtml(value, {
    allowedTags: [
      "p", "div", "br", "strong", "b", "em", "i", "u", "s",
      "h2", "h3", "h4", "ul", "ol", "li", "blockquote", "a", "span", "font",
    ],
    allowedAttributes: {
      a: ["href", "target", "rel"],
      span: ["style"],
...
export function jobDescriptionToText(value: string): string {
