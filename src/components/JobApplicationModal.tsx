...
import { ArrowRightIcon, CheckIcon, ChevronDownIcon, CloseIcon } from "@/components/icons";
...
function SuccessState({ close }: { close: () => void }) { return <div className="px-8 py-20 text-center" role="status"><div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#dce8dc] text-[#476047]"><CheckIcon size={30} /></div><p className="mt-6 font-display text-xs font-bold uppercase tracking-[0.22em] text-[#B85F1E]">Application sent</p><h3 className="mt-3 font-display text-3xl font-bold tracking-tight">Now leave the rest to us.</h3><p className="mx-auto mt-3 max-w-md leading-relaxed text-[#7a5e4a]">Thank you for applying. We will review your experience and contact you if there is a match.</p><button type="button" onClick={close} className="mt-8 rounded-full bg-gradient-to-b from-[#F2924A] to-[#D9702A] px-7 py-3.5 text-sm font-semibold text-[#2A1B0E] transition-colors hover:from-[#F6A263] hover:to-[#E27C33]">Back to opportunities</button></div>; }
